...
MODEL_LIST: Dict[str, Any] = {
    "Pytorch": {
        "SD-1.5": {
            "model_provider_path": "core.models.images.text2img.model_stable_diffusion",
        ...
        "SD-2": {
            "model_provider_path": "core.models.images.text2img.model_stable_diffusion_2",
        ...
        "SD-XL": {
            "model_provider_path": "core.models.images.text2img.model_stable_diffusion_xl",
        ...
        "SD-3": {
            "model_provider_path": "core.models.images.text2img.model_stable_diffusion_3",
