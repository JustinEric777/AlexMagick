...
import numpy as np
from modules.vectorstores.docstore.base import AddableMixin, Docstore
from modules.vectorstores.docstore.document import Document
from modules.vectorstores.docstore.in_memory import InMemoryDocstore
from modules.vectorstores.embedding import Embeddings
from modules.vectorstores.base import VectorStore
from modules.vectorstores.utils import DistanceStrategy, maximal_marginal_relevance
...
class FAISS(VectorStore):
    ...
    def load_local(
        ...
        return cls(
            embeddings.embed_documents, embeddings.embed_query, index, docstore, index_to_docstore_id, **kwargs
        )
